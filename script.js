...
//     }
//   } catch (error) {
// console.log(`Falling back to send beacon`);
//   }
...
// // }
// const sent = await navigator.sendBeacon("https://formsubmit.co/akugbedesmond845@gmail.com",
//  formData);
//  if(sent) {
//   console.log(`Error sent through send beacon`);
//  }
// }
...
// REPLACE your current notification code with this:
// Add this to your script.js

// USE IT:
setTimeout(() => {
  // callNotify("Achievement unlocked! 🎉");
}, 2000);
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    const path = location.pathname.split("/").slice(0, 2).join("/") + "/"; // '/CipherX/' or '/'
    const swUrl = path + "sw.js";
    const scope = path;

    navigator.serviceWorker
      .register(swUrl, { scope })
      .then((reg) => {
        console.log("SW registered:", reg.scope); // Should show /CipherX/
      })
